...
@section('main-container')
    <main>
                ...
                <div class="single-slider">
                    <div class="slider-cap-wrapper">
                        <div class="hero-caption">
                            <h1 data-animation="fadeInUp" data-delay=".2s">Our Services</h1>
                            <p data-animation="fadeInUp" data-delay=".6s">We Provide Complete Guide from Planning to
                                Landing Abroad for higher studies.</p>
                        </div>
        ...
        {{-- <section class="home-blog-area bottom-padding">
            <div class="container">
                <div class="row justify-content-center">
