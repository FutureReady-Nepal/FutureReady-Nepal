                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-8">
                        <div class="single-footer-caption mb-50">
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-logo mb-20 d-flex">
                                    <a href="index.html"><img id="logo" src="{{ url('/img/logo/logo.png') }}"
                                            alt=""></a>
                                    <h2 class="logo-title" style="color: white;">Future Ready Nepal</h2>
                                </div>
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vaafb692b2aea4879b33c060e79fe94621666317369993"
    ...
    data-cf-beacon='{"rayId":"7844fbbdb9bc85ab","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2022.11.3","si":100}'
